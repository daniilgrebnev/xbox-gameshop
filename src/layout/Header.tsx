		...
		<div className='fixed top-0 left-0 w-screen bg-black h-[70px] flex justify-between items-center z-50 select-none'>
			<div className='container flex justify-between items-center'>
				<div className='flex items-center select-none'>
					...
					<p className='font-righteous text-2xl ml-5 text-green'>Xbox-Gaming</p>
				</div>
				<nav className='text-white text-xl font-righteous tracking-widest flex justify-between items-center'>
